  ...
  return (
    <div className="box-wrapper flex w-full justify-start p-4 ">
      ...
      <Box
        ...
        subheading={
          "You are the admin of this brilliant application, thus you have the power to create the business accounts as well as direct client accounts"
        }
      >
